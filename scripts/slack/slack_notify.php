...
switch($slack_type) {
case 'circle_start':
    $project_name = getenv('CIRCLE_PROJECT_REPONAME');
    $user_name = getenv('CIRCLE_PROJECT_USERNAME');
    $slack_agent = 'CircleCI';
    $slack_icon = 'http://live-drupalcon-github-magic.pantheonsite.io/sites/default/files/icons/circle.png';
    $slack_color = '#229922';
    $slack_message = 'Code is changing on GitHub! Kicking off a new build - https://circleci.com/gh/' . $user_name  . '/' . $project_name . '/' . $argv[2];
